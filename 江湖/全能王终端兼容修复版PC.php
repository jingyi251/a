    ...
    foreach ($目录项 as $项目) {
        ...
        if (is_dir($路径)) {
            ...
            if (in_array($扩展名, $文件类型)) {
                $相对路径 = str_replace('C:\\Program Files\\PeekPili\\data\\江湖\\', '', $路径);
...
function 获取所有文件() {
    ...
    if ($所有文件 === null) {
        ...
        $JSON文件 = 递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\json\\影视\\', ['json']);
        $TXT文件 = 递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\wj\\', ['txt']);
        $M3U文件 = array_merge(
            递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\json\\影视\\', ['m3u']),
            递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\wj\\', ['m3u'])
        );
        
        // 增强数据库文件扫描，包含所有可能的数据库路径
        $数据库文件 = array_merge(
            递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\json\\影视\\', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\wj\\', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\db\\', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\wj\\bt\\', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\data\\', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('C:\\Program Files\\PeekPili\\data\\江湖\\数据库\\', ['db', 'sqlite', 'sqlite3', 'db3'])
        );
